...
import { MODELS, HOUSE_PHOTOS, QUALITY_SEALS } from '../constants';
import { Model } from '../types';
import ModelCard from '../components/ModelCard';
import ModelModal from '../components/ModelModal';
import { MapPin, Camera, ArrowUpRight, X, MessageCircle, Phone, Lock, Info, Award, ShieldCheck, Users, ChevronLeft, ChevronRight } from 'lucide-react';
...
const AgencyPage: React.FC = () => {
  ...
  return (
    <div className="pt-24 md:pt-32 pb-24 min-h-screen bg-black relative overflow-hidden">
      <div className="absolute top-0 right-0 w-[800px] h-[800px] bg-red-900/5 blur-[150px] rounded-full -z-10"></div>
      
      <div className="container mx-auto px-4">
        {/* Section 1: Hero & Sobre Nós */}
        <section className="mb-24 md:mb-32">
          <div className="text-center mb-16 md:mb-24">
            <span className="text-[9px] md:text-[10px] uppercase font-black tracking-[0.5em] text-red-600 mb-4 block animate-pulse">Agência Morena Bruta</span>
            <h1 className="text-4xl md:text-8xl font-black text-white tracking-tighter uppercase leading-[0.9] mb-6">
              O Novo Padrão de <br className="hidden md:block"/> <span className="text-transparent bg-clip-text bg-gradient-to-r from-red-500 to-red-800 italic">Luxo e Prazer.</span>
            </h1>
          </div>
            ...
            <div className="space-y-6 md:space-y-8">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 md:gap-6">
                {QUALITY_SEALS.map((seal) => (
                  <div key={seal.id} className="glass p-5 md:p-6 rounded-2xl border-white/5 hover:neon-border-red transition-all group">
        ...
        <section className="mb-24 md:mb-32">
          <div className="flex flex-col md:flex-row md:items-center justify-between mb-8 md:mb-12 gap-4">
            <div>
              ...
              <p className="text-gray-500 font-bold uppercase text-[9px] tracking-[0.4em] mt-2 italic">Destaques do Catálogo</p>
            </div>
            <div className="flex gap-2">
              <button onClick={() => scrollCarousel('left')} className="w-10 h-10 md:w-12 md:h-12 glass rounded-full flex items-center justify-center text-white hover:bg-red-600 transition-all border-white/10">
                <ChevronLeft size={20} />
              </button>
              <button onClick={() => scrollCarousel('right')} className="w-10 h-10 md:w-12 md:h-12 glass rounded-full flex items-center justify-center text-white hover:bg-red-600 transition-all border-white/10">
        ...
        <section className="mb-24 md:mb-32">
          <div className="glass p-6 md:p-16 rounded-[2.5rem] md:rounded-[4rem] border-white/5 relative overflow-hidden">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 md:gap-16 items-center">
              <div className="space-y-6 md:space-y-8">
                <div className="inline-flex items-center gap-2 px-3 py-1 bg-red-600/10 rounded-full border border-red-600/20 text-red-500 text-[9px] font-black uppercase tracking-widest">
                ...
                <h2 className="text-3xl md:text-6xl font-black text-white uppercase tracking-tighter leading-[1] md:leading-[0.9]">
                  Nossa Sede <br/> <span className="text-red-600 italic">Privativa.</span>
                </h2>
                ...
                <div className="p-4 glass rounded-2xl border-white/5 flex items-center gap-4">
                  <div className="p-2 bg-red-600/10 rounded-xl text-red-500 shrink-0"><Lock size={18}/></div>
                  <div>
                ...
                <button 
                  ...
                  className="w-full md:w-auto bg-white text-black hover:bg-red-600 hover:text-white px-8 py-4 rounded-xl font-black text-[11px] uppercase tracking-widest flex items-center justify-center gap-2 transition-all shadow-lg active:scale-95"
                >
        ...
        <section className="mb-24">
          <div className="mb-12">
            <h2 className="text-3xl md:text-5xl font-black text-white tracking-tighter uppercase leading-none mb-3">Pólos <span className="text-red-600 italic">Estratégicos</span></h2>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 md:gap-6">
            {regions.map((region) => (
              <div 
                ...
                className="group relative h-72 md:h-96 rounded-[2rem] overflow-hidden cursor-pointer glass border-white/5 hover:neon-border-red transition-all"
              >
                ...
                <div className="absolute bottom-6 left-6 right-6">
                  ...
                  <p className="text-red-500 text-[9px] font-black uppercase tracking-widest">{region.count} VIP Models</p>
                </div>
              </div>
            ))}
          </div>
        ...
        <div className="fixed inset-0 z-[250] flex items-end md:items-center justify-center p-0 md:p-6 lg:p-12">
          ...
          <div className="relative glass w-full max-w-6xl h-[95vh] md:h-[90vh] rounded-t-[2.5rem] md:rounded-[3rem] overflow-hidden flex flex-col md:flex-row border-white/10 shadow-2xl animate-in slide-in-from-bottom-10 duration-500">
            ...
            <div className="w-full md:w-[40%] p-8 md:p-12 flex flex-col justify-center bg-zinc-950">
              <div className="space-y-6 md:space-y-8">
                <h3 className="text-3xl md:text-5xl font-black text-white uppercase tracking-tighter leading-tight">Explore o <span className="text-red-600">Santuário.</span></h3>
                ...
                <div className="flex flex-col gap-3 pt-4">
                  <a href="https://wa.me/5551999999999" target="_blank" className="flex items-center justify-center gap-2 w-full bg-green-600 text-white py-4 rounded-xl font-black text-sm transition-all shadow-lg active:scale-95">
        ...
        <div className="fixed inset-0 z-[250] flex items-end md:items-center justify-center p-0 md:p-6 lg:p-12">
          ...
          <div className="relative glass w-full max-w-6xl h-[95vh] md:h-[85vh] rounded-t-[2.5rem] md:rounded-[3rem] p-6 md:p-12 overflow-y-auto custom-scrollbar border-white/10 shadow-2xl animate-in slide-in-from-bottom-10 duration-500">
            <div className="flex items-center justify-between mb-8 md:mb-12 sticky top-0 bg-transparent py-2 z-10">
               <div>
                 <h2 className="text-3xl md:text-6xl font-black text-white uppercase tracking-tighter leading-none">Elite <span className="text-red-600">{selectedRegion}</span></h2>
                 <p className="text-gray-500 font-bold uppercase text-[9px] tracking-[0.4em] mt-2">Catálogo Regional Exclusivo</p>
               </div>
               <button onClick={() => setSelectedRegion(null)} className="p-2.5 bg-white/5 hover:bg-red-600 text-white rounded-full transition-all border border-white/10">
                  <X size={20}/>
               </button>
            </div>
