          ...
          <div>
            ...
            <div className="space-y-8">
              <div className="flex items-start gap-6 group">
                <div className="w-12 h-12 bg-red-700/10 rounded-xl flex items-center justify-center shrink-0 group-hover:bg-red-700 transition-all">
                ...
                <div>
                  ...
                  <p className="text-gray-400">(51) 99655-4609</p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-6 group">
                ...
                <div>
                  ...
                  <p className="text-gray-400">contato@morenabruta.com</p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-6 group">
                ...
                <div>
                  ...
                  <p className="text-gray-400">Cachoeira do Sul - RS</p>
                </div>
              </div>
            </div>
            ...
            <form className="space-y-6" onSubmit={(e) => e.preventDefault()}>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="space-y-2">
                  ...
                  <input type="text" className="w-full bg-black border border-white/5 rounded-xl py-4 px-6 text-white focus:outline-none focus:border-red-600" placeholder="Seu Nome" />
                </div>
                <div className="space-y-2">
                  <label className="text-[10px] uppercase font-black text-gray-500 tracking-widest px-1">WhatsApp</label>
                  <input type="text" className="w-full bg-black border border-white/5 rounded-xl py-4 px-6 text-white focus:outline-none focus:border-red-600" placeholder="(51) 99999-9999" />
                </div>
              </div>

              <div className="space-y-2">
                <label className="text-[10px] uppercase font-black text-gray-500 tracking-widest px-1">Detalhes do Pedido</label>
                <textarea rows={5} className="w-full bg-black border border-white/5 rounded-xl py-4 px-6 text-white focus:outline-none focus:border-red-600 resize-none" placeholder="Qual modelo e horário você deseja?"></textarea>
              </div>

              <button className="w-full bg-red-700 hover:bg-red-600 text-white py-5 rounded-xl font-black text-lg transition-all transform hover:scale-[1.02]">
